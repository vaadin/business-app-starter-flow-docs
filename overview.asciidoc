...
|`UIUtils.createLabel(FontSize.XL, "I'm extra large");` or `component.addClassName(FontSize.XL.getClassName());`
...
|`UIUtils.createLabel(TextColor.SUCCESS, "Success");` or `component.addClassName(TextColor.SECONDARY.getClassName());`
|===
