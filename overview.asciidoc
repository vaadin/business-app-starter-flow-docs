...
=== Utility Classes
A number of utility classes were introduced to make theming more consistent and efficient.

==== Buttons
The most common button variations can be created with `UIUtils`. The methods below accept `String` and/or `VaadinIcon`.
