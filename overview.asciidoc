...
.Master-detail view with the `DetailsDrawer` shown on the far right.
image::images/details-drawer.png[Master-detail view with the `DetailsDrawer` shown on the far right.]
