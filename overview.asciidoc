...
|`UIUtils.createLabel(FontSize, String)`, `UIUtils.createLabel(FontSize, TextColor, String)` or `component.addClassName(FontSize.XS.getClassName());`
...
|`IconSize`
|`S`, `M`, `L`
|`UIUtils.createSmallIcon(VaadinIcon)`, `UIUtils.createLargeIcon(VaadinIcon)` or `UIUtils.createIcon(IconSize, TextColor, VaadinIcon);`

|`TextColor`
|`HEADER`, `BODY`, `SECONDARY`, `TERTIARY`, `DISABLED`, `PRIMARY`, `PRIMARY_CONTRAST`, `ERROR`, `ERROR_CONTRAST`, `SUCCESS`, `SUCCESS_CONTRAST`
|`UIUtils.createLabel(FontSize, String)`, `UIUtils.createLabel(FontSize, TextColor, String)` or `component.addClassName(TextColor.SECONDARY.getClassName());`
|===
