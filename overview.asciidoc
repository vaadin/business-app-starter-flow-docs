...
images/app-bar.png[AppBar with a main menu icon, title, tabs and avatar.]
...
=== ListItem
image::images/list-item-1.png

=== NaviTabs
Tabs that when clicked navigate to a specific target (view) and that can be closed.

image::images/navi-tabs.png[]

Any component can be placed in the suffix and prefix slots.
