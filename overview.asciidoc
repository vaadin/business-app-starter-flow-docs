...
|`createLabel(FontSize, String)`, `createLabel(FontSize, TextColor, String)` or `component.addClassName(FontSize.XS.getClassName());`
...
|`component.addClassName(TextColor.SECONDARY.getClassName());`
|===
