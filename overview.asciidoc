...
=== AppBar
A header component consisting of a main menu icon, contextual navigation icon, title, tabs, action items and avatar. All building blocks are optional.
...
=== TabBar
A simpler version of `AppBar` that discards the contextual navigation icon and title.
