...
=== ListItem
A list item made up of a prefix, primary text, secondary text and suffix. Any component can be placed in the prefix and suffix slots.

image::images/list-item-1.png[align=center]
