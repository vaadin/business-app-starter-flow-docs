...
Lumo uses CSS custom properties to define typography, colors, sizing, spacing etc. Most visual styles can be achieved by tweaking these properties. For the more intricate theming use link:https://github.com/vaadin/vaadin-themable-mixin/wiki[`ThemableMixin`s].
